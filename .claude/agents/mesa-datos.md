...
# Mesa de Dinero — Datos de mercado · capa **Sonnet**
...
**Por qué Sonnet:** cablear conectores y normalizar libros es **ejecución acotada y reversible**. El
juicio caro (qué significan esos números) vive en `mesa-costos` y `mesa-falsacion`.
