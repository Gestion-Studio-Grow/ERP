...
`docs/organizacion/asignacion-modelos-sprint.md` (retirado: todo corre en Opus 5.5 desde 2026-09-23; histórico: Sonnet default de ejecución, Opus solo PMO/Auditoría
...
- **Arquitecto de Solución (ejecutor · Opus 5.5)** — **ejecuta lo reversible** del plan aprobado; **eleva lo irreversible** (ADR-048/049).
- **Advisory + Challenger (Opus 5.5)** — **tensionan** la estrategia antes de fundamento (puntual, ADR-045).
- **QA / Probador (Opus 5.5)** — **prueba como usuario real**; verifica antes de cerrar.
...
**B· FRENTES — según el sprint:** Preset IA · Producto por rubro · Adaptador/Delivery por cliente — todo en Opus 5.5 · **ERP cores** (Pagos·Caja·Inventario/POS·Fiscal·Plataforma/Deploy·Diseño, Opus 5.5) · **Agencia Digital** (Consultores/Mercado·Devs·PMO·Growth·WhatsApp). *(Importaciones = trigger propio `impo`, Opus 5.5.)*
...
> **🔁 Pool compartido (ADR-053):** los agentes se **PRESTAN** entre estructuras para casos puntuales (antes de crear uno nuevo, verificar si el pool ya lo cubre). El agente prestado **extiende su calibración** a la estructura destino y, **al cerrar el caso, VUELVE a su célula/división de origen** (no se re-parenta ni se duplica) volcando lo aprendido al registro de lecciones. Los préstamos los **coordina el Arquitecto de Solución**.
