---
description: Estructura de IMPORTACIONES de GSG disparada por el dueño — equipo de análisis/oportunidades de importación desde China, TODO en Opus 5.5 (alto juicio/estratégico). Al decir "impo" se auto-abren las células (en olas si superan el tope de 4 concurrentes).
---
...
de Claude Code aislada por cada célula** de la estructura de abajo, **todas en Opus 5.5** (decisión del
...
- **TODO en Opus 5.5** — cada célula **etiqueta su modelo explícitamente** (`/model opus` o el parámetro
...
## Estructura que se auto-abre al decir `impo` (6 células · TODAS Opus 5.5)
...
- **Desde esta sesión orquestadora (PMO):** despachás **un subagente por célula** (Agent tool / `Task`),
  cada uno en **Opus 5.5** explícito, respetando el **tope de 4 concurrentes** (en olas). Cada subagente
