...
| HEAD | `d5185e1` (2026-07-13) |
| Árbol | **5 archivo(s) sin commitear** |
...
- 206555a · 2026-07-12 · docs(handoff): corrige §2 — las 3 guardas viven en 4 superficies, no solo order-core
...
| Fuente | Volumen |
|---|---:|
| Documentos en `docs/` | 296 |
| Palabras en `docs/` | 424.343 |
| ADRs | 81 |
