...
- **[MP-15](MP-15-da-el-resultado-correcto-no-es-evidencia-de-que-este-bien.md)** — al afirmar que dos implementaciones se validan cruzado, decir qué parte es independiente. Si comparten una pieza (acá: el evaluador de manos), el cruce no cubre esa pieza y hay que darle su propia […]
