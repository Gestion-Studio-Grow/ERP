...
| `public/lab/mesa-cripto/index.html` → `/lab/mesa-cripto` | **App demo fase 1** (decisión del dueño 2026-09-02, "avanza"): calculadora de rieles + panel de costos BTC 15 m. Artifact privado de revisión: https://claude.ai/code/artifact/90a6535a-fa90-4b00-a4b7-8e6883c9c83d |
