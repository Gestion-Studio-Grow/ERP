...
**Sesiones sin consolidar: 3** <!-- +1 por el cierre de arquitectura ADR-028 (Panel de Dirección), 2026-07-07 -->
...
> **Guía de lectura para el equipo:** el libro de usuario amigable de este sistema es `docs/MANUAL-SESIONES.md`, y el comando `/manual` muestra la versión corta al instante. Para **incorporar a alguien nuevo** (persona o agente) y llevarlo a operar de élite —modelo mental, ruta de ramp día 1/semana 1, estándar de operación, y cómo se entrena/mejora a los agentes— está `docs/ONBOARDING-EQUIPO.md`. **Cómo se reporta el avance** (estados canónicos 🟢 Avanzable ya · ✅ Completado — pendiente acción humana · 🔒 Gated, y cómo se calcula el %): `docs/METODOLOGIA-REPORTE-AVANCE.md`; el **mapa vivo de frentes** bajo esa metodología: `docs/ESTADO-FRENTES.md`. No son tipos de sesión (no abren trabajo), son la puerta de entrada; este tablero sigue siendo la spec canónica.
