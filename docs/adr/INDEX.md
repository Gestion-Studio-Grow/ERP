...
| 010 | Convergencia piloto → plataforma | El piloto Beauty & Spa (Next.js, mono-tenant) se declara Fase 1 y debe evolucionar hacia los ADR. Gap analysis: 6 brechas foundacionales caras de diferir (tenant_id+RLS, overbooking al motor, soft-delete, audit, precio congelado/notas, timezone), 4 importantes no urgentes, 5 de plataforma diferidas al 2º cliente. Decisión pendiente: Camino A (evolucionar Next.js) vs. B (reconstruir en NestJS). |
