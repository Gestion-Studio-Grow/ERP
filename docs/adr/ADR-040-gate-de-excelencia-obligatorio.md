...
**Relacionado:** ADR-033 (excepción de copia exacta), ADR-043 (sello de marca GSG), ADR-039 (sprint)
...
1. **🔎 Auditoría SAP Fiori — completa (7 ángulos):** role-based · coherente · simple · adaptable ·
   delightful/enterprise · **accesibilidad** · **consistencia**.
