...
- **Modelo de trabajo GSG:** 008 (semilla) → 032 (modelos + concurrencia + prioridades) → 039 (sprint) → 040 (Gate) → 016 (handoff) → **045 (Advisory + Challenger)** → **047 (retroalimentación)** → **048 (Arquitecto de Solución)** → **049 (RACI)** → **050 (roster fijo de sprint)** → **051 (roster completo GSG)** → **052 (calibración universal)** → **053 (pool compartido + cross-training)**.
