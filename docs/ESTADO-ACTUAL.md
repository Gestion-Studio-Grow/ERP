...
| **I7** | ~~Autorización de marca (ADR-042) de Shine/ADM~~ → ✅ **OTORGADA por el dueño 2026-07-07**. **Nueva dependencia:** el DX-5 fiel quedó bloqueado porque las fuentes reales son inaccesibles (IG login-walled; sin web/TiendaNube pública). **Falta que el dueño aporte el MATERIAL REAL** (bio/about, catálogo+precios reales, testimonios reales de IG/WhatsApp) o una sesión de navegador con acceso al IG. | acción dueño (aportar material) | cierra el copy DX-5 exacto de Shine/ADM (hoy provisional) + repone reseñas reales. Ver `docs/estrategia/F1-vidrieras-calibracion-y-gate-adr042.md` |
