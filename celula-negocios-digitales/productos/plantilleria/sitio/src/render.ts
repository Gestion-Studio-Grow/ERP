...
function header(): string {
  return `<header class="header">
    <div class="contenedor header-in">
      <a href="${ruta("/")}" class="logo">Plantillería<span class="logo-ar">.ar</span></a>
      <nav class="nav">
        <a href="${ruta("/")}#catalogo">Plantillas</a>
        <a href="${ruta("/")}#faq">Preguntas</a>
        <a class="cart-link" href="${ruta("/carrito")}" aria-label="Ver carrito">
          🛒 <span class="cart-count" data-cart-count hidden>0</span>
        </a>
        <a class="btn btn-primario btn-sm" href="${ruta("/")}#catalogo">Ver catálogo</a>
      </nav>
    </div>
  </header>`;
}
...
<head>
  ...
  <link rel="stylesheet" href="${ruta("/globals.css")}" />
</head>
<body>
  ${bannerDemo()}
  ${header()}
  ...
  <script type="module" src="${ruta("/app.js")}"></script>
</body>
</html>`;
}
...
function cardPlantilla(p: Plantilla): string {
  return `<article class="card card-plant">
    <a class="card-link" href="${ruta(`/producto/${attr(p.slug)}`)}">
      <div class="badges">
    ...
    <div class="card-foot">
      ...
      <a class="btn btn-secundario btn-sm" href="${ruta(`/producto/${attr(p.slug)}`)}">Ver ficha →</a>
    </div>
...
export function producto(p: Plantilla): string {
  ...
  <section>
    <div class="contenedor estrecho-md">
      <a class="volver" href="${ruta("/")}#catalogo">← Volver al catálogo</a>
      ...
      <div class="prod">
        ...
        <div class="card compra">
          ...
          <a class="btn btn-secundario btn-block btn-comprar-ya" href="${ruta("/carrito")}"
...
export function carrito(): string {
  ...
  <section>
    <div class="contenedor estrecho-md">
      <h1>Tu carrito</h1>
      <div data-cart-view>
        <p class="soft" data-cart-empty>Tu carrito está vacío. <a href="${ruta("/")}#catalogo">Elegí una plantilla →</a></p>
      </div>
    </div>
  </section>`;
  return page({
...
export function checkout(): string {
  ...
  <section>
    <div class="contenedor estrecho-md">
      <a class="volver" href="${ruta("/carrito")}">← Volver al carrito</a>
      <h1>Pagar</h1>
  ...
  <section>
    <div class="contenedor centro estrecho-md">
      ...
      ${
        ...
        <a class="btn btn-secundario" href="${ruta(`/producto/${attr(upsell.slug)}`)}">Ver plantilla →</a>
      </div>`
          : ""
      }

      <p class="mt"><a href="${ruta("/")}#catalogo">← Volver al catálogo</a></p>
    </div>
  </section>`;
  return page({
