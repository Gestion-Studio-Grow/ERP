    ...
    <main className="mx-auto max-w-4xl px-6 py-8 space-y-12">
      ...
      <section>
        ...
        <form action={createProfessionalNews} className="rounded-lg border border-line p-4 flex flex-wrap gap-2 mb-4">
          <select name="professionalId" required className="rounded-md border border-line-strong bg-surface-raised px-2 py-1.5 text-sm text-strong focus:border-accent">
            {professionals.map((p) => (
