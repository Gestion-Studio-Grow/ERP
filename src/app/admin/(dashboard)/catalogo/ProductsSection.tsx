...
function ProductRow({ product }: { product: Product }) {
      ...
      <tr className="border-b bg-neutral-50">
        <td colSpan={5} className="p-0">
          <form
            ...
            className="grid grid-cols-[1fr_100px_90px_90px_auto] items-center gap-2 px-4 py-2.5"
          >
  ...
  return (
    <tr className="border-b last:border-b-0">
      <td className={`px-4 py-2.5 text-sm ${product.active ? "" : "text-neutral-400 line-through"}`}>
        {product.name}
      </td>
      <td className="px-4 py-2.5 text-sm text-neutral-600">{product.unit}</td>
...
export default function ProductsSection({ products }: { products: Product[] }) {
  ...
  return (
    <section>
      ...
      <form action={createProduct} className="grid grid-cols-4 gap-2">
