...
// ============================================================================
//
// El layout, el Inicio y los números del Inicio necesitan lo mismo del negocio (su slug para
// `APPS_INICIO`, su rubro para "Mostrador"/"Recepción" y para decir "cortes" o "productos").
