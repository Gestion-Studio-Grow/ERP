...
export { AGENDA_RUBROS, AGENDA_RUBRO_IDS, getAgendaRubro, GENERIC_AGENDA_WORDING } from "./rubros";
export type { AgendaRubro, AgendaWording, AgendaService } from "./rubros";
