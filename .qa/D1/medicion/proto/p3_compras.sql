-- D1 · p3_compras: la plata de estas columnas pasa de Float a numeric(14,2), en el lugar.
...
DECLARE
  ...
  pares text[][] := ARRAY[
    ...
    ['StockPurchaseItem', 'unitCost'],
    ['StockPurchaseItem', 'lineTotal']
  ];
BEGIN
  ...
  ALTER TABLE "StockPurchase" ADD COLUMN "totalCost_float" double precision;
  UPDATE "StockPurchase" SET "totalCost_float" = "totalCost";
  ALTER TABLE "StockPurchase" ALTER COLUMN "totalCost" TYPE numeric(14,2) USING round("totalCost"::numeric, 2);
  ALTER TABLE "StockPurchaseItem" ADD COLUMN "unitCost_float" double precision, ADD COLUMN "lineTotal_float" double precision;
  UPDATE "StockPurchaseItem" SET "unitCost_float" = "unitCost", "lineTotal_float" = "lineTotal";
  ALTER TABLE "StockPurchaseItem" ALTER COLUMN "unitCost" TYPE numeric(14,2) USING round("unitCost"::numeric, 2), ALTER COLUMN "lineTotal" TYPE numeric(14,2) USING round("lineTotal"::numeric, 2);
