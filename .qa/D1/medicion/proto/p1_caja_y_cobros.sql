-- D1 · p1_caja_y_cobros: la plata de estas columnas pasa de Float a numeric(14,2), en el lugar.
...
DECLARE
  ...
  pares text[][] := ARRAY[
    ['CashMovement', 'amount'],
    ['CashSession', 'openingFloat'],
    ['CashSession', 'closingExpected'],
    ['CashSession', 'closingCounted'],
    ['CashSession', 'closingDiff'],
    ['Payment', 'amount'],
...
BEGIN
  ...
  ALTER TABLE "CashMovement" ADD COLUMN "amount_float" double precision;
  UPDATE "CashMovement" SET "amount_float" = "amount";
  ALTER TABLE "CashMovement" ALTER COLUMN "amount" TYPE numeric(14,2) USING round("amount"::numeric, 2);
  ALTER TABLE "CashSession" ADD COLUMN "openingFloat_float" double precision, ADD COLUMN "closingExpected_float" double precision, ADD COLUMN "closingCounted_float" double precision, ADD COLUMN "closingDiff_float" double precision;
  UPDATE "CashSession" SET "openingFloat_float" = "openingFloat", "closingExpected_float" = "closingExpected", "closingCounted_float" = "closingCounted", "closingDiff_float" = "closingDiff";
  ALTER TABLE "CashSession" ALTER COLUMN "openingFloat" TYPE numeric(14,2) USING round("openingFloat"::numeric, 2), ALTER COLUMN "closingExpected" TYPE numeric(14,2) USING round("closingExpected"::numeric, 2), ALTER COLUMN "closingCounted" TYPE numeric(14,2) USING round("closingCounted"::numeric, 2), ALTER COLUMN "closingDiff" TYPE numeric(14,2) USING round("closingDiff"::numeric, 2);
  ALTER TABLE "Payment" ADD COLUMN "amount_float" double precision;
  UPDATE "Payment" SET "amount_float" = "amount";
  ALTER TABLE "Payment" ALTER COLUMN "amount" TYPE numeric(14,2) USING round("amount"::numeric, 2);
  ALTER TABLE "CommissionPayout" ADD COLUMN "amount_float" double precision;
  UPDATE "CommissionPayout" SET "amount_float" = "amount";
  ALTER TABLE "CommissionPayout" ALTER COLUMN "amount" TYPE numeric(14,2) USING round("amount"::numeric, 2);
