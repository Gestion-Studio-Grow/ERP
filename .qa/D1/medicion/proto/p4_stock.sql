-- D1 · p4_stock: la plata de estas columnas pasa de Float a numeric(14,2), en el lugar.
...
BEGIN
  ...
  ALTER TABLE "StockMovement" ADD COLUMN "unitCost_float" double precision;
  UPDATE "StockMovement" SET "unitCost_float" = "unitCost";
  ALTER TABLE "StockMovement" ALTER COLUMN "unitCost" TYPE numeric(14,2) USING round("unitCost"::numeric, 2);
