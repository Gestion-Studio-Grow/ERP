-- D1 · p2a_servicios_y_turnos: la plata de estas columnas pasa de Float a numeric(14,2), en el lugar.
...
BEGIN
  ...
  ALTER TABLE "Service" ADD COLUMN "price_float" double precision, ADD COLUMN "residentPrice_float" double precision, ADD COLUMN "depositAmount_float" double precision;
  UPDATE "Service" SET "price_float" = "price", "residentPrice_float" = "residentPrice", "depositAmount_float" = "depositAmount";
  ALTER TABLE "Service" ALTER COLUMN "price" TYPE numeric(14,2) USING round("price"::numeric, 2), ALTER COLUMN "residentPrice" TYPE numeric(14,2) USING round("residentPrice"::numeric, 2), ALTER COLUMN "depositAmount" TYPE numeric(14,2) USING round("depositAmount"::numeric, 2);
  ALTER TABLE "Appointment" ADD COLUMN "priceAtBooking_float" double precision, ADD COLUMN "discountAmount_float" double precision;
  UPDATE "Appointment" SET "priceAtBooking_float" = "priceAtBooking", "discountAmount_float" = "discountAmount";
  ALTER TABLE "Appointment" ALTER COLUMN "priceAtBooking" TYPE numeric(14,2) USING round("priceAtBooking"::numeric, 2), ALTER COLUMN "discountAmount" TYPE numeric(14,2) USING round("discountAmount"::numeric, 2);
